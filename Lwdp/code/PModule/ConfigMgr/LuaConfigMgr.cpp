...
** Generated automatically by tolua++-1.0.92 on 11/06/12 21:27:37.
*/
...
#endif
   tolua_pushusertype(tolua_S,(void*)&self->AttribName,"tstring");
 return 1;
}
...
#endif
  self->AttribName = *((tstring*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
#endif
   tolua_pushusertype(tolua_S,(void*)&self->AttribValue,"tstring");
 return 1;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CAttributeStru_AttribValue(lua_State* tolua_S)
{
  ...
  if ((tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"tstring",0,&tolua_err)))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->AttribValue = *((tstring*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
