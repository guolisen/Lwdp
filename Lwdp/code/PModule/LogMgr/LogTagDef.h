...
#define LW_LOGMGR_TABLE_WINID_TAG		__T("WinId")

#define LW_LOGMGR_TYPE_STD_TAG			__T("STD")
#define LW_LOGMGR_TYPE_FILE_TAG			__T("FILE")
#define LW_LOGMGR_TYPE_ROLFILE_TAG		__T("ROLFILE")
#define LW_LOGMGR_TYPE_REMOTE_TAG		__T("REMOTE")

#define LW_LOGMGR_LOG_PATTERN_TAG		__T("LogPattern")
#define LW_LOGMGR_GLOBAL_LEVEL_TAG		__T("GlobalLevel")
